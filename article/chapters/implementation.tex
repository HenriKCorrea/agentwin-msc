...
Designing the cross-domain use case revealed an immediate representational problem:
    ...
    \texttt{opendigitaltwins-energygrid} ontology
...
The \texttt{opendigitaltwins-energygrid} repository describes its models as adapted from
...
A patch was applied to a fork of the ontology
    (\texttt{HenriKCorrea/opendigitaltwins-energygrid}~\cite{correaHenriKCorreaOpendigitaltwinsenergygrid2026}):
